<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-2">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg relative">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 text-center h-80 scrollable">
                <div class="main-flex items-center">
                    ...
                    <div>
                        <h1 class="text-xl font-semibold">Add saldo</h1>
                        <form method="POST" class="w-min">
                            @csrf <!-- {{ csrf_field() }} -->
                            <input name="user_id" type="hidden" value="{{ Auth::user()->user_id}}">
                            <input name="first_name" type="hidden" value="{{ Auth::user()->first_name}}">
                            ...
                            <div class="border">
                                <input type="number" name="add_saldo" value="0">
                            </div>

                            <button formaction="settings/saldo" type="submit" class="block bg-blue-500 my-3 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mx-auto">Add</button>
                        </form>
